...
export default function ClassReportCards() {
  ...
  const [grades, setGrades] = useState<Record<string, Record<string, Record<number | string, any>>>>({});
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const gradesMap: Record<string, Record<string, Record<number | string, any>>> = {};
    ...
    <div className="bg-white shadow rounded-lg p-6 max-w-4xl mx-auto">
      ...
      <div className="print:p-0">
        {students.map((student, index) => {
          ...
          // Use class subjects if available, otherwise fallback to subjects with grades
          const subjectsToDisplay = classSubjects.length > 0 
            ? classSubjects 
            : Object.keys(studentGrades).sort();
            ...
            <div key={student.id} className={index < students.length - 1 ? "break-after-page mb-16 print:mb-0" : ""}>
              <div className="mb-8 border-b-2 border-gray-800 pb-6 flex justify-between items-start">
                ...
                <div className="text-right flex-1 ml-4">
                  ...
                  <h2 className="text-xl font-semibold text-gray-700 mt-2">Boletim Escolar - {classData?.name}</h2>
              ...
              <div className="mt-16 flex justify-between px-12 print:px-0">
                ...
                <div className="text-center w-64">
                  <div className="border-t border-gray-800 pt-2">
                    <p className="text-sm font-bold text-gray-700">Assinatura do Professor</p>
                  </div>
                </div>
              </div>
            </div>
